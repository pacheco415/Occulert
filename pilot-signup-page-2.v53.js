...
async function saveLead(event){
  ...
  }catch(e){error.textContent='Your request was not saved. Please try again later or email fleet@occulert.com.';error.style.display='block';error.setAttribute('tabindex','-1');error.focus()}
