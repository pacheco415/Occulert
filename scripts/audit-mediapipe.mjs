...
assert.ok(readFileSync('driver-app.v60.js', 'utf8').includes("FACE_MESH_ASSET_BASE='/vendor/mediapipe/"));
assert.equal(createHash('sha384').update(readFileSync(root + 'face_mesh.js')).digest('base64'), readFileSync('driver-app.v60.js', 'utf8').match(/FACE_MESH_SCRIPT_INTEGRITY='sha384-([^']+)'/)[1]);
