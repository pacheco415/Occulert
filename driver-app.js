...
async function start(){
  ...
  try{
    ...
    if(e&&e.name==='AbortError'){
      ...
      const recovery=cameraRecoveryGuidance(e);setOverlay(recovery.title,recovery.text,recovery.hint,false);log('Camera error: '+(e.message||e.name||e));
    }
