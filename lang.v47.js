...
(function(){
    const translations = {
          en: {
                  ...
                  stats_value1: "On-device",
                  stats_label1: "Camera frames are processed locally",
                  stats_value2: "App open",
                  stats_label2: "Monitoring stops when Occulert leaves the screen",
                  stats_value3: "No account",
                  stats_label3: "Local monitoring works without fleet sync",
                  stats_value4: "Beta",
                  stats_label4: "May miss events or trigger false alerts",
          ...
          es: {
                  ...
                  stats_value1: "En el dispositivo",
                  stats_label1: "Los fotogramas de la cámara se procesan localmente",
                  stats_value2: "App abierta",
                  stats_label2: "La supervisión se detiene cuando Occulert deja la pantalla",
                  stats_value3: "Sin cuenta",
                  stats_label3: "La supervisión local funciona sin sincronización de flota",
                  stats_value4: "Beta",
                  stats_label4: "Puede pasar por alto eventos o generar falsas alertas",
          ...
          fr: {
                  ...
                  stats_value1: "Sur l'appareil",
                  stats_label1: "Les images de la caméra sont traitées localement",
                  stats_value2: "App ouverte",
                  stats_label2: "La surveillance s'arrête quand Occulert quitte l'écran",
                  stats_value3: "Sans compte",
                  stats_label3: "La surveillance locale fonctionne sans synchronisation de flotte",
                  stats_value4: "Bêta",
                  stats_label4: "Peut manquer des événements ou déclencher de fausses alertes",
          ...
          pt: {
                  ...
                  stats_value1: "No dispositivo",
                  stats_label1: "Os quadros da câmera são processados localmente",
                  stats_value2: "App aberto",
                  stats_label2: "O monitoramento para quando o Occulert sai da tela",
                  stats_value3: "Sem conta",
                  stats_label3: "O monitoramento local funciona sem sincronização de frota",
                  stats_value4: "Beta",
                  stats_label4: "Pode deixar eventos passar ou gerar alertas falsos",
          ...
          de: {
                  ...
                  stats_value1: "Auf dem Gerät",
                  stats_label1: "Kamerabilder werden lokal verarbeitet",
                  stats_value2: "App geöffnet",
                  stats_label2: "Die Überwachung stoppt, wenn Occulert nicht mehr angezeigt wird",
                  stats_value3: "Ohne Konto",
                  stats_label3: "Lokale Überwachung funktioniert ohne Flottensynchronisierung",
                  stats_value4: "Beta",
                  stats_label4: "Kann Ereignisse übersehen oder Fehlalarme auslösen",
          ...
          ar: {
                  ...
                  stats_value1: "على الجهاز",
                  stats_label1: "تتم معالجة إطارات الكاميرا محليًا",
                  stats_value2: "التطبيق مفتوح",
                  stats_label2: "تتوقف المراقبة عندما لا يكون Occulert ظاهرًا على الشاشة",
                  stats_value3: "بلا حساب",
                  stats_label3: "تعمل المراقبة المحلية من دون مزامنة الأسطول",
                  stats_value4: "تجريبي",
                  stats_label4: "قد يفوّت حالات نعاس أو يطلق تنبيهات كاذبة",
          ...
          zh: {
                  ...
                  stats_value1: "设备端",
                  stats_label1: "摄像头画面仅在本机处理",
                  stats_value2: "应用开启",
                  stats_label2: "Occulert 离开屏幕后监测即停止",
                  stats_value3: "无需账户",
                  stats_label3: "本地监测无需车队同步即可使用",
                  stats_value4: "测试版",
                  stats_label4: "可能漏检事件或触发误报",
          ...
          ja: {
                  ...
                  stats_value1: "デバイス上",
                  stats_label1: "カメラ映像は端末内で処理されます",
                  stats_value2: "アプリ表示中",
                  stats_label2: "Occulert が画面から離れると監視は停止します",
                  stats_value3: "アカウント不要",
                  stats_label3: "ローカル監視にフリート同期は不要です",
                  stats_value4: "ベータ版",
                  stats_label4: "見逃しや誤警報が発生する場合があります",
